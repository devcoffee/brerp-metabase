...
COMENTÁRIOS: Soma dos pagamentos completados, fechados , estornados e  anulados, classificando 
o saldo conciliado, não conciliado e projetado(conciliado + não conciliado)  agrupando por conta corrente e organização. O filtro de org
aplica na conta bancária por causa de transações de de transferências bancárias.Valores tratatos para  conversão em operações de multimoeda
######################################################################################################################################
*/
WITH pagamentos as (
    SELECT 
